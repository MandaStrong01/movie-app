...
export default function App() {
  ...
  // OWNER OVERRIDE: Defaulted to 'Studio' plan ($50) with no Free tier available
  ...
  return (
    <div className="h-screen bg-transparent overflow-hidden relative font-sans selection:bg-purple-600 selection:text-white">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb { background: #8a2be2; border-radius: 40px; border: 4px solid black; }
        input[type=range] { -webkit-appearance: none; background: #18181b; border-radius: 20px; }
        input[type=range]::-webkit-slider-thumb { -webkit-appearance: none; height: 50px; width: 50px; border-radius: 50%; background: #8a2be2; cursor: pointer; border: 8px solid white; shadow: 0 0 30px rgba(138,43,226,0.9); }
